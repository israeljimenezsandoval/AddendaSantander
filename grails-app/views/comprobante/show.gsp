			...
			<div class="span9">
				...
				<dl>
					...
					<g:if test="${comprobanteInstance?.name}">
						<dt><g:message code="comprobante.name.label" default="Name" /></dt>
						
							<dd><g:fieldValue bean="${comprobanteInstance}" field="name"/></dd>
				...
				<g:form>
					...
					<div class="form-actions">
						<g:link class="btn" action="edit" id="${comprobanteInstance?.id}">
